...
from data_p import HistoDataNorm
...
def check_dataset(dataset, augmentation, missing):
    if dataset == "malaria":
        ...
        domain_list_train.remove(missing)
        domain_list_train.append(missing + '_m')


        dataset = HistoDataNorm('missing_Uninfected/', domain_list=domain_list_train, augmentation=augmentation)
        ...
        dataset = HistoDataNorm('missing_Parasitized/', domain_list=domain_list_train, augmentation=augmentation)
